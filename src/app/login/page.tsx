    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-muted/30 p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Accede a la plataforma educativa utilizando tu cuenta de Google.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex justify-center">
          <form
            ...
            className="w-full"
          >
            <Button className="w-full py-6 text-base" variant="default" type="submit">
        ...
        <CardFooter>
          <p className="text-xs text-center text-muted-foreground w-full mt-4">
